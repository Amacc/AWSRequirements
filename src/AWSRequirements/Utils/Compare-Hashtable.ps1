function Compare-Hashtable {
    <#
        ...
        .DESCRIPTION
            The Compare-Hashtable function computes differences between two
            Hashtables. Results are returned as an array of objects with the
            properties: "key" (the name of the key that caused a difference),
            "side" (one of "<=", "!=" or "=>"), "lvalue" an "rvalue" (resp. the
            left and right value associated with the key).
        ...
        .EXAMPLE
            Returns a difference for a ("3 <="), c (3 "!=" 4), e ("=>" 5) and
            g (6 "<=").
        ...
        .NOTES
            I want to thank dbroeglin for the creation of this function.

        .LINK
            https://gist.github.com/dbroeglin/c6ce3e4639979fa250cf#file-compare-hashtable-ps1
    #>
    [CmdletBinding()]
    param (
